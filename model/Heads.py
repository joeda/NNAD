    ...
    def call(self, x, train_batch_norm=False):
        ...
        if self.box_branch:
            ...
            if self.box_delta_regression:
                bb_targets, cls_targets, depth_targets, obj_targets, embedding_targets, delta_targets = box_results
            else:
                bb_targets, cls_targets, depth_targets, obj_targets, embedding_targets = box_results
            results['bb_targets_offset'] = bb_targets
            results['bb_targets_cls'] = cls_targets
            results['bb_targets_depth'] = depth_targets
