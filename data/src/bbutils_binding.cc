...
public:
                                                              ...
                                                              pybind11::buffer embeddingBuffer, double threshold)
    {
        ...
        pybind11::buffer_info depthBufferInfo = depthBuffer.request();
        ...
        checkBufferInfo<float, 1>(depthBufferInfo);
        ...
        for (auto &bbutils : m_bbutils) {
            ...
            VectorView<float> depth(static_cast<const float *>(depthBufferInfo.ptr) + prevNum, num);
            ...
            auto det = bbutils->bbListFromTargets(objectnessScores, objectClass, depth, regression, deltaRegression, embedding,
